function R_DOSL = cal_Rdosl_acquired(R1a, R2a, R1b, MPF, R, T2b, T1d,dw, w1, TSL, B1, B0, SNR)
...
DeltaR1rho1 = abs(-log(Md_1 ./ Ms_1) ./ TSL);
DeltaR1rho2 = abs(-log(Md_2 ./ Ms_1) ./ TSL);

% Final Ratio
R_DOSL = squeeze(DeltaR1rho1 ./ DeltaR1rho2);
