function Rdosl_exact = cal_RATIO_dosl_exact(R1a, R2a, R1b, MPF, R, T2b, T1d, dw, w1)
    M0b = MPF;
    M0a = 1-M0b;
    fb = M0b/M0a;
    kba = R*M0a;
    ...
    Rdosl1 = R1rho(1,1) - R1rho(1,2);
    Rdosl2 = R1rho(2,1) - R1rho(1,2);

    if abs(Rdosl2) < 1e-10
        Rdosl_exact = NaN;
    else
        Rdosl_exact = abs(Rdosl1/Rdosl2);
        %Rdosl_exact = abs(Rdosl2);
    end
end